...
class SurveyTable extends React.Component {
    ...
    createData = (survey, completed, invited_date) => {
        return {survey, completed, invited_date};
    };
    ...
    initializeRows = (invitations) => {
        ...
        invitations.map(invitation => {
            ...
            arr.push(this.createData(invitation.used_survey.survey_name, completed, invitation.invited_date));
        });
        return arr;
    };
